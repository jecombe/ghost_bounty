...
export const GHOST_BOUNTY_ABI = [
  ...
  { type: "function", name: "emergencyCancelBounty", inputs: [{ name: "bountyId", type: "uint256" }], outputs: [], stateMutability: "nonpayable" },
  { type: "function", name: "getBounty", inputs: [{ name: "bountyId", type: "uint256" }], outputs: [{ name: "creator", type: "address" }, { name: "repoOwner", type: "string" }, { name: "repoName", type: "string" }, { name: "issueNumber", type: "uint64" }, { name: "status", type: "uint8" }, { name: "claimedBy", type: "address" }, { name: "createdAt", type: "uint256" }, { name: "pendingSince", type: "uint256" }], stateMutability: "view" },
