  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-blue-300/60 max-w-xl mx-auto">
      ...
      <div className="flex justify-center gap-4">
        <Link
          href="/bounty"
          className="px-6 py-3 rounded-xl font-bold text-sm bg-gradient-to-r from-cyan-500 to-blue-600 text-white hover:from-cyan-400 hover:to-blue-500 transition-all shadow-lg shadow-cyan-900/30"
        >
          Launch App
        </Link>
        <Link
          href="/docs"
          className="px-6 py-3 rounded-xl font-bold text-sm bg-white/[0.06] text-blue-300/70 hover:text-white hover:bg-white/[0.1] border border-white/[0.08] transition-all"
        >
          Read the Docs
        </Link>
      </div>
